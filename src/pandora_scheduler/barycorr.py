...
See also: 
    http://astroutils.astronomy.osu.edu/exofast/barycorr.html
    http://astroutils.astronomy.osu.edu/time/utc2bjd.html
    http://astroutils.astronomy.osu.edu/time/bjd2utc.html
"""
...
def bvc(jd_utc, ra, dec, obsname=None, lat=None, lon=None, elevation=None,
    ...
    See also: http://astroutils.astronomy.osu.edu/exofast/barycorr.html
    ...
    result = _query_webserver(
        'http://astroutils.astronomy.osu.edu/exofast/barycorr.php',
        params,
        len(jd_utc)
    )
...
def utc2bjd(jd_utc, ra, dec, raunits='degrees'):
    ...
    See also: http://astroutils.astronomy.osu.edu/time/utc2bjd.html
    ...
    return _query_webserver(
        'https://astroutils.astronomy.osu.edu/time/convert.php',
        params,
        len(jd_utc)
    )
...
def bjd2utc(bjd_tdb, ra, dec, raunits='degrees'):
    ...
    See also: http://astroutils.astronomy.osu.edu/time/bjd2utc.html
